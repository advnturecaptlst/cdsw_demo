...
# sets (A, B, C, and D); specify which of them to use
chess_sets = ['A','B','C']
...
# specify the number of "classes" (types of chess pieces)
ct_classes = len(chess_pieces)

# specify the number of nodes in each layer
ct_layer_nodes_1 = 1024
ct_layer_nodes_2 = 512
ct_layer_nodes_3 = 256
ct_layer_nodes_4 = 128
ct_layer_nodes_5 = 64
ct_layer_nodes_6 = 32

# specify the learning rate (speed of gradient descent)
lr_val = 0.000001

# hidden_units = [ct_layer_nodes_1, ct_layer_nodes_2...]
model = tf.estimator.DNNClassifier(
    feature_columns=my_feature_columns,
    hidden_units=[ct_layer_nodes_1, ct_layer_nodes_2,ct_layer_nodes_3,ct_layer_nodes_4,ct_layer_nodes_5,ct_layer_nodes_6],
    optimizer=tf.train.AdamOptimizer(
      learning_rate=lr_val
    ),
    label_vocabulary=chess_pieces,
    n_classes=ct_classes
)
...
# chess sets 
img_dir = img_root + '/non_b/'
# img_dir = img_root + '/weird/'
