...
model = LinearRegression() # model is untrained at this point
...
# modifies model object but doesn't output anything
# default is fit_intercept=True, fit_intercept=False forces the model line to go through (0,0)
...
# score is a feature of the model
# if you run model.score(train_x, train_y) you'll get R^2 close to 1

# Call the `predict` method to use the trained model to
# make predictions on the test set
test_pred = model.predict(test_x)
# test_pred is the regression line you can overlay on the scatterplot of test data
...
# model
model.coef_
# for every 1mm of base diameter you go up, you'll see ~ +3.4g of weight
...
# going to use the same test & train data from above
